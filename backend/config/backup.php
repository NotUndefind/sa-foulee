...
return [
    ...
    'backup' => [
        ...
        'source' => [
            'files' => [
                 ...
                 * Vide : on ne sauvegarde que la base de données (les fichiers du code
                 * sont dans git, les documents membres déjà sur R2).
                 */
                'include' => [],
        ...
        'destination' => [
             ...
             * R2 (Cloudflare) : déjà configuré dans filesystems.php. BACKUP_DISK
             * permet de pointer un bucket dédié aux backups si besoin.
             */
            'disks' => [
                env('BACKUP_DISK', 'r2'),
            ],
     ...
     */
    'notifications' => [
        // Mail uniquement en cas de problème (pas de mail quotidien de succès).
        'notifications' => [

...
Route::prefix("v1")->group(function () {
    ...
    Route::prefix("webhooks")->group(function () {
        Route::post("helloasso", [
            HelloAssoWebhookController::class,
            "handle",
    ...
    Route::middleware("auth:sanctum")->group(function () {
        ...
        Route::middleware("role:admin|founder|bureau")->group(function () {
            ...
            Route::get("inventory/{equipment}", [
                EquipmentController::class,
                "show",
            ]);
            Route::post("inventory", [EquipmentController::class, "store"]);
            Route::patch("inventory/{equipment}", [
                EquipmentController::class,
                "update",
            ]);
            // Attributions
            Route::post("inventory/{equipment}/assign", [
                EquipmentAssignmentController::class,
                "assign",
            ]);
            Route::patch("inventory/assignments/{assignment}/return", [
                EquipmentAssignmentController::class,
                "return",
            ]);
        });
        ...
        Route::middleware("role:admin|founder")->group(function () {
            Route::delete("inventory/{equipment}", [
                EquipmentController::class,
                "destroy",
            ]);
        });
        ...
        Route::middleware("role:admin|founder")->group(function () {
            Route::get("admin/newsletter/subscribers", [
                NewsletterController::class,
                "subscribers",
            ]);
            Route::get("admin/newsletter/subscribers/export", [
                NewsletterController::class,
                "exportSubscribers",
            ]);
            // Campagnes
            Route::get("admin/newsletter/campaigns", [
                CampaignController::class,
                "index",
            ]);
            Route::post("admin/newsletter/campaigns", [
                CampaignController::class,
                "store",
            ]);
            Route::patch("admin/newsletter/campaigns/{campaign}", [
                CampaignController::class,
                "update",
            ]);
            Route::post("admin/newsletter/campaigns/{campaign}/send", [
                CampaignController::class,
                "send",
            ]);
        });
        ...
        Route::middleware("role:admin|founder")->group(function () {
            ...
            Route::patch("documents/{document}/status", [
                DocumentController::class,
                "updateStatus",
            ]);
        });
        ...
        Route::delete("events/{event}/register", [
            EventController::class,
            "unregister",
        ]);
        ...
        Route::post("events/{event}/photos", [
            EventPhotoController::class,
            "store",
        ]);
        Route::delete("event-photos/{photo}", [
            EventPhotoController::class,
            "destroy",
        ]);
        ...
        Route::get("sessions/templates", [
            SessionController::class,
            "templates",
        ]);
        Route::get("sessions/{session}", [SessionController::class, "show"]);
        Route::post("sessions/{session}/participate", [
            SessionController::class,
            "participate",
        ]);
        ...
        Route::middleware("role:admin|founder|coach|bureau")->group(
            function () {
                ...
                Route::patch("posts/{post}/pin", [
                    PostController::class,
                    "pin",
                ]);
                Route::post("uploads/media", [
        ...
        Route::get("users/{user}/performances", [

    ...
    <>
      ...
      <div className="ev-page min-h-screen pb-24 lg:pb-8" style={{ background: '#F8F8F8' }}>
        <div className="mx-auto max-w-5xl px-5 py-8">
          {/* ── Header ─────────────────────────────────────────────────── */}
          <div
            className="ev-fade mb-8 flex items-start justify-between"
          ...
          {view === 'list' && (
            <>
              {/* Filters */}
              <div
                className="ev-fade mb-5 flex flex-wrap items-center gap-3"
              ...
              >
                <div className="flex flex-wrap gap-2">
                  {TYPE_OPTIONS.map((o) => (
                    <button
                      key={o.value}
                      onClick={() =>
                        setFilters((f) => ({ ...f, type: o.value as EventType | '', page: 1 }))
                      }
                ...
                <label className="ev-upcoming-toggle ml-auto">
                  <input
                    ...
                    onChange={(e) =>
                      setFilters((f) => ({ ...f, upcoming: e.target.checked, page: 1 }))
                    }
                  />
              ...
              {loading ? (
                ...
                <div
                  className="flex flex-col items-center justify-center gap-3 rounded-2xl bg-white"
                  style={{
                ...
                >
                  ...
                  {!hasActiveFilter && meta.total === 0 ? (
                    <>
                      <div>
                        ...
                        <p className="text-xs" style={{ color: '#7F7F7F' }}>
                          Créez la première sortie de l&apos;association !
                        </p>
                      </div>
                      {canManageEvents && (
                        <button
                    ...
                    <p className="text-sm font-semibold" style={{ color: '#C0302E' }}>
                ...
                <div
                  className="ev-fade grid gap-4 sm:grid-cols-2 lg:grid-cols-3"

...
export default function ResetPasswordForm() {
  ...
  if (!token || !email) {
    return (
      <div className="space-y-4 text-center">
        ...
        >
          <svg viewBox="0 0 24 24" className="h-6 w-6" style={{ color: '#FB3936' }} fill="none" stroke="currentColor" strokeWidth="1.5">
            <path d="M12 9v4m0 4h.01M10.29 3.86L1.82 18a2 2 0 001.71 3h16.94a2 2 0 001.71-3L13.71 3.86a2 2 0 00-3.42 0z" strokeLinecap="round" strokeLinejoin="round"/>
          </svg>
        </div>
        <h1 className="text-xl font-bold" style={{ color: '#C0302E' }}>Lien invalide</h1>
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} noValidate className="space-y-5">
      <div>
        <h1 className="text-2xl font-bold" style={{ color: '#C0302E' }}>Nouveau mot de passe</h1>
        <p className="mt-1 text-sm" style={{ color: '#7F7F7F' }}>Choisis un mot de passe d&apos;au moins 8 caractères.</p>
      </div>
      ...
      <div>
        <label htmlFor="password" className="mb-1 block text-sm font-medium" style={{ color: '#2C2C2C' }}>
      ...
      <div>
        <label htmlFor="password_confirmation" className="mb-1 block text-sm font-medium" style={{ color: '#2C2C2C' }}>
        ...
        {errors.password_confirmation && (
          <p className="mt-1 text-xs" style={{ color: '#FB3936' }}>{errors.password_confirmation.message}</p>
        )}
      </div>

    ...
    <>
      ...
      <div className="ss-page min-h-screen pb-24 lg:pb-8" style={{ background: '#F8F8F8' }}>
        <div className="mx-auto max-w-5xl px-5 py-8">
          {/* ── Header ─────────────────────────────────────────────────── */}
          <div
            className="ss-fade mb-8 flex items-start justify-between"
          ...
          >
            <button
              ...
              className={`ss-tab ${tab === 'sessions' ? 'active' : ''}`}
            >
              Sessions publiées
            </button>
            {canManageSessions && (
          ...
          {loading && tab === 'sessions' ? (
            ...
            <div
              className="ss-fade flex flex-col items-center justify-center gap-3 rounded-2xl bg-white"
              style={{
            ...
            <div
              className="ss-fade grid gap-4 sm:grid-cols-2 lg:grid-cols-3"
